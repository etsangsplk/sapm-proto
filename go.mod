...
require (
	...
	github.com/google/addlicense v0.0.0-20191205215950-c6b7f1e7f34a
	github.com/jaegertracing/jaeger v1.15.0
	...
	github.com/signalfx/jaegermodel v0.0.0-20191216114100-739a7d453026
